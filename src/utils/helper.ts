...
const extractValueFromDurationString = (
  strDuration: string,
  units: Array<string>,
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const deepValue = (obj: any, str: string): string | any[] => {
  str = str.replace(/^\./, '');
  const a = str.split('.');
...
// Code from https://github.com/lukeleppan/better-word-count/blob/main/src/stats.ts
